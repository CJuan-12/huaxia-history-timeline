...
export const metadata: Metadata = {
  ...
  description: "以横向时间轴和朝代文化版图浏览从夏商周到清末的中国古代历史，通过帝王关系星谱检索 443 位君主身份档案，查看地域风气、社会习俗、重大事件、关系行为与分级置信的 MBTI 候选。",
  openGraph: {
    title: "华夏长卷｜中国古代历史时间轴",
    description: "横向穿行 23 个历史时期，以文化版图观察风气与习俗，并探索 443 位君主身份档案。",
